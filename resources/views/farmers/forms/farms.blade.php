<div class="row farms">
    {!! Form::open([
        ...
        <div class="form-group">
            ...
            {!! Form::select(
                    'Locality_ID', $locals->prepend('من فضلك اختار', 0), null, ['class' => 'form-control Locality_ID']
                ) !!}
        </div>
        ...
        <div class="form-group">
            ...
            {!! Form::select(
                    'Village_ID', $villages->prepend('من فضلك اختار', 0), null, ['class' => 'form-control Village_ID']
                ) !!}
        </div>
