<div class="row farms">
    {!! Form::open([
            'route' => ['admin.farmers.addFarm', $farmer ?? session('farmer')], 'class' => 'farms']) !!}
            ...
            <tbody>
                @forelse($farmer->farms ?? session('farmer')->farms ?? [] as $farm)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.farms.edit', $farm) }}" class="btn btn-sm btn-primary edit"
                                data-action="{{ route('admin.farms.update', $farm) }}"  data-form="farms">تعديل</a>
                        </td>
                        <td>
                            {!! Form::open(['method' => 'DELETE', 'route' => ['admin.farms.destroy', $farm]]) !!}
